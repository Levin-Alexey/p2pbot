...
export async function handleBuyUsdtCallback({ token, callbackQuery }) {
	...
	await fetch(editUrl, {
		...
		body: JSON.stringify({
			...
			text: "✅ Вы выбрали: <b>ПОКУПКА USDT</b>\nДля вас будет сформирована ссылка и по ней вы будете перенаправлены в <b>официальное P2P-объявление от ИП Скоринкин Иван (ИНН 773610853200)</b> на бирже Bybit.\n\nДля подписчиков канала действует <b>специальная скидка на курс обмена в обе стороны.</b> \n\nЭТА СКИДКА ДОСТУПНА ТОЛЬКО В ДАННОМ БОТЕ.\n\n<b>🔐 Важно: </b>Вся сделка проходит <b>исключительно внутри Bybit по правилам криптобиржи.</b>\n\nДеньги зачисляются напрямую на Ваш аккаунт на бирже - быстро и без риска.",
			parse_mode: "HTML",
			reply_markup: {
				inline_keyboard: [
